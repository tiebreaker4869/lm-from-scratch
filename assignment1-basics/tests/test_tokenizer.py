...
def test_from_files_matches_reference_loader():
    ...
    reference_tokenizer = get_tokenizer_from_vocab_merges_path(
    ...
    for s in test_strings:
        assert tokenizer.encode(s) == reference_tokenizer.encode(s)
